...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		healthBar.createFilledBar(0xFFFF0000, 0xFFDF5CD0);
		// healthBar
		add(healthBar);

		// Add Kade Engine watermark
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - N-100's KE " + MainMenuState.kadeEngineVer : ""), 16);
		...
		// literally copy-paste of the above but with botplay lol
